...
class TcpStreamClient : public Application
{
   ...
   */
    void Initialise(std::string algorithm, uint16_t clientId, const Ptr<PhyRxStatsCalculator> ccrossLayerInfo);
   ...
   */
    ...
    int64_t m_downloadedCounter;                     //!< The maximum index of the segment ever been downloaded
