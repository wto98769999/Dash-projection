...
NS_LOG_COMPONENT_DEFINE("Sara1Algorithm");
NS_OBJECT_ENSURE_REGISTERED(Sara1Algorithm);

Sara1Algorithm::Sara1Algorithm(const videoData &videoData,
    ...
    : AdaptationAlgorithm(videoData, playbackData, bufferData, throughput),
      ...
      m_bufferMin(m_videoData.segmentDuration * 2), m_alpha1(0.40),
      m_alpha2(0.80), m_beta(0.10),
...
algorithmReply Sara1Algorithm::GetNextRep(const int64_t segmentCounter,
...
void Sara1Algorithm::Normalize(const videoData &videoData,
...
int64_t Sara1Algorithm::Esmoothing(
