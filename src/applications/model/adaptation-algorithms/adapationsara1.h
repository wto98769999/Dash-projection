#ifndef SARA1_ALGORITHM_H
#define SARA1_ALGORITHM_H

#include "tcp-stream-adaptation-algorithm.h"

namespace ns3 {

class Sara1Algorithm : public AdaptationAlgorithm {
public:
  Sara1Algorithm(const videoData &videoData, const playbackData &playbackData,
